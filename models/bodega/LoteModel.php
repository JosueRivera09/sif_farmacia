...
function obtenerStockTotal(mysqli $conexion) {
...
function obtenerLotesPorVencer(mysqli $conexion) {
...
function contarLotes(mysqli $conexion) {
...
function obtenerLotesPaginados(mysqli $conexion, int $limit, int $offset) {
    $lotes = [];
...
function obtenerProductosParaIngreso(mysqli $conexion) {
    $productos = [];
...
function obtenerLaboratoriosParaIngreso(mysqli $conexion) {
    $laboratorios = [];
...
function contarBodegasActivas(mysqli $conexion) {
...
function obtenerTodosLosLotes(mysqli $conexion) {
    $lotes = [];
    $query = "SELECT l.numero_lote, l.bodega, p.nombre_commercial, c.nombre_categoria, l.cantidad_recibida, l.fecha_vencimiento, l.fecha_creacion, p.unidad_medida, la.nombre_laboratorio
              FROM lotes l
              JOIN productos p ON l.id_producto = p.id_producto
