...
<div class="main-content">
    ...
    <div class="panel-izquierdo" style="margin:30px;">
        <div class="panel-titulo">
            <i class="fa-solid fa-truck"></i> Tickets
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($v['estado_venta'] === 'Pagado'): ?>
                                    <form method="post" action="confirmar_despacho.php" onsubmit="return confirm('¿Confirmar despacho?');">
                                        <input type="hidden" name="id_venta" value="<?php echo (int)$v['id_venta']; ?>">
                                        <button class="btn-sif" type="submit">Entregar</button>
                                    </form>
                                <?php else: ?>
                                    <button class="btn-sif" disabled>No disponible</button>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr><td colspan="6" style="text-align:center;">No hay tickets</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
